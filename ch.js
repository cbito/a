  const canales = [
    ...
    {
      title: "MEGALODON",
      svg: `<svg xmlns="http://www.w3.org/2000/svg" width="160" height="160" viewBox="0 0 160 160"><rect width="160" height="160" fill="#0000FF"/><text x="80" y="85" font-family="Arial" font-size="30" fill="#FFFFFF" text-anchor="middle">MEGALODON</text></svg>`,
